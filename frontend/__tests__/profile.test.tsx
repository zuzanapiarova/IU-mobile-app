...
//     // TS-safe cast for useRouter
//     (useRouter as jest.Mock).mockReturnValue({ replace: mockReplace } as Partial<Router>);
...
//     const changeButton = screen.getByText('Change Name');
...
//   it('toggles theme preference', async () => {
//     render(<ProfileScreen />);
//     const switches = screen.getAllByRole('switch'); // first switch is theme
//     fireEvent(switches[0], 'valueChange', false);
...
//   it('toggles notifications', async () => {
//     render(<ProfileScreen />);
//     const switches = screen.getAllByRole('switch'); // second switch is notifications
//     fireEvent(switches[1], 'valueChange', false);
...
//   it('disables Save Limits button if limits invalid', () => {
//     render(<ProfileScreen />);
//     const successInput = screen.getByDisplayValue('80');
//     fireEvent.changeText(successInput, '10'); // invalid: less than failure

//     const saveButton = screen.getByText('Save Limits');
...
//     // The logout modal opens
//     const modalLogoutButton = screen.getByText('Logout');
//     fireEvent.press(modalLogoutButton);
...
//   it('handles time picker confirm', async () => {
//     render(<ProfileScreen />);
//     const switches = screen.getAllByRole('switch');
//     fireEvent(switches[1], 'valueChange', true); // enable notifications

//     // Simulate time picker confirm
//     const newTime = new Date();
//     newTime.setHours(15);
//     newTime.setMinutes(30);

//     const ProfileScreenModule = require('../app/(tabs)/profile').default;
//     const instance: any = new ProfileScreenModule();
//     instance.handleTimePickerConfirm(newTime);

//     expect(instance.selectedTime).toBe('15:30');
//   });
// });
